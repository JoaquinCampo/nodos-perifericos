...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("w-[300px] p-3", className)}
      month={currentMonth}
      classNames={{
        months:
  ...
  (
    ...
    return (
      <div className="flex h-9 items-center">
        ...
        >
          <SelectTrigger ref={ref} onKeyDown={handleKeyDown}>
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
    ...
    return (
      <Popover>
        ...
        <PopoverContent className="w-auto p-0">
          ...
          />
          {granularity !== "day" && (
            <div className="border-border max-w-[300px] border-t p-2">
              <TimePicker
                onChange={(value) => {
                  onChange?.(value);
                  setDisplayDate(value);
